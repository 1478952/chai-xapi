...
(function(root) {
    ...
    if (typeof root === 'undefined' || typeof root.TextEncoder === 'undefined') {
...
(function (ADL) {
    ...
    */
    ...
    XAPIWrapper.prototype.getState = function(activityid, agent, stateid, registration, since, callback)
    {
        if (this.testConfig())
        {
            ...
            var result = ADL.XHR_sync_request(this.lrs, url, "GET", null, this.lrs.auth,
            // var result = ADL.XHR_request(this.lrs, url, "GET", null, this.lrs.auth,
              callback, null, true, null, this.withCredentials, this.strictCallbacks);
    ...
    */
    ...
    ADL.XHR_sync_request = function(lrs, url, method, data, auth, callback, callbackargs, ignore404, extraHeaders, withCredentials, strictCallbacks)
    {
        "use strict";
